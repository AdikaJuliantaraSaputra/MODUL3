...
public class main {
    public static void main(String[] args) {
        ...
        while(lanjut.equals("Y")){
            ...
            System.out.print("UNIVERSITAS  : "); DataUniv.univ = input.nextLine();
            System.out.print("NIM          : "); DataUniv.NIM = input.nextLine();
            System.out.print("NAMA         : "); DataUniv.Nama = input.nextLine();
